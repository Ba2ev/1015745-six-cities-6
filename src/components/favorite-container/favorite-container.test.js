...
describe(`FavoriteContainer should render snapshots correctly`, () => {
  it(`FavoriteContainer should render snapshot correctly with empty offers`, () => {
    const favorites = [];

    const {container} = render(<FavoriteContainer offers={favorites}/>);

    expect(container).toMatchSnapshot();
  });

  it(`FavoriteContainer should render snapshot correctly with favorite offers`, () => {
    const favorites = [
      {
        "city": {
          "name": `Paris`,
