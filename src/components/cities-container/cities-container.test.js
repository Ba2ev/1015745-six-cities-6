...
describe(`CitiesContainer should render correctly`, () => {
  it(`CitiesContainer should render correctly with empty offers`, () => {
    const offers = [];

    const {getByText} = render(<CitiesContainer offers={offers}/>);
  ...
  it(`CitiesContainer should render correctly with offers`, () => {
    const offers = [
      {
        "city": {
          "name": `Paris`,
    ...
    const title = getByText(/laces to stay/i);
...
describe(`CitiesContainer should render snapshots correctly`, () => {
  it(`CitiesContainer should render snapshot correctly with empty offers`, () => {
    const offers = [];

    const {container} = render(<CitiesContainer offers={offers}/>);

    expect(container).toMatchSnapshot();
  });

  it(`CitiesContainer should render snapshot correctly with offers`, () => {
    const offers = [
      {
        "city": {
          "name": `Paris`,
