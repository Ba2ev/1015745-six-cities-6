...
const BookmarkBtn = ({btnType, isFavorite}) => {
  return (
    <button className={`${bookmarkBtnTypesParams[btnType].BTN_CLASS}__bookmark-button ${isFavorite ? `${bookmarkBtnTypesParams[btnType].BTN_CLASS}__bookmark-button--active` : ``} button`} type="button">
